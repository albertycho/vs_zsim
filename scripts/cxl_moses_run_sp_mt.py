...
pcommand = '"/home/azureuser/CXL_WD/Tailbench/tailbench/moses/bin/moses_integrated -config moses.ini -input-file /home/azureuser/CXL_WD/WD/tailbench.inputs/moses/testTerms -threads '+num_server +' -num-tasks 10000 -verbose 0";'
...
f2.write('process0 = {\n')
#f2.write('env = "TBENCH_WARMUPREQS=0 TBENCH_RANDSEED='++'";\n')
#f2.write('ffiPoints = "1500000000 10000000000000";\n')
